     ...
     <body style="background-image:url('./images/lightg.jpg');">
        <form id="adform" action="admsnform.php" method="post">
            ...
            <div id="dmid" class="container-fluid">  
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <font style="color:white; margin-left:520px; font-family: sans-serif; width:100%; font-size:30px;">
            ...
            <table class="frmtbl">
                ...
                <tr border="1" class="hdrow">
                  ...
                  <tr>
                          <td> <font style="font-family: Verdana;"><h4>Welcome to CIT, <?php echo $stname;?></h4> </font> </td>
                    <td colspan="2"> 
                ...
                <tr>
                    <center>
					   <td colspan="4"><input type="radio" id="cat" name="cat" value="SC"><font style="font-family: Verdana;">SC</font>
                        ...
                        <input type="radio" id="cat" name="cat" value="GEN"><font style="font-family: Verdana;">GEN</font></td></center>
                 </tr>
               ...
               <tr>
                     ...
                     <td><input type="text" id="col" name="col" required="true">
                <tr>
                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           ...
                           <tr>
                               ...
                               <td><input type="text" id="pom1".lp name="pom1" class="actab" required="true"></td>
                           </tr>
                           <tr>
                           ...
                           <tr>
                               ...
                               <td colspan="3">
                                    <input type="radio" id="moi" name="moi" value="Kannada"><font style="font-family: Verdana;">Kannada</font>
