...
?>
      <form id="admin" action="admin.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/cutm.png" width="100%" style="box-shadow: 0px 5px 5px #999999; "></img>
                  </div>
                 </div>    
             </div>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 ...
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                    CHANNABASAVESHWARA INSTITUTE OF TECHNOLOGY - GUBBI</font></center>
                
                <center><font style="font-family:Verdana; font-size:18px;">
                    Phone :0816-4021402 / 403 , 9449637043, 8867354168, Email:info@cittumkur.org 
                    </font></center>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        <font style="font-family: Verdana; font-size:15px;"> 5) View Instructions</font>
                                        <p align="right" style="font-family: Verdana; font-size:15px;">
